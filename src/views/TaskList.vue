<template>
    <div class="container my-5">
        <h1 class="text-center mb-4">Actividades a realizar</h1>
        <button @click="fetchTasks" class="btn btn-dark w-100 mb-3">Rastrear Actividades</button>
            ...
            <div v-for="task in tasks" :key="task.id" class="list-group-item">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        ...
                        <button @click="deleteTask(task)" class="btn btn-sm btn-danger ms-2">Erradicar</button>
                    </div>
                </div>
            </div>
        </div>

        <p v-else class="text-center text-muted">No hay actividades pendientes...</p>
    </div>
</template>
